...
Builds concise normative security policies for applications handling sensitive
or regulated data.

### Entrypoints

- security Blue Book, control policy, data handling, incident, or launch gates

### Inputs / Outputs

- Inputs: system scope, data classes, trust boundaries, identity, storage, and retention.
- Outputs: enforceable MUST/SHOULD/CAN policy and go/no-go checklist.

### Dependencies / Tooling

Use `security-threat-model` for threat discovery and
`security-best-practices` for implementation review.
...
- Unknown controls remain explicit TODOs.
